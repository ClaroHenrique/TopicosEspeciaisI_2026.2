...
Fonte: [XII Maratona de Programação dos Alunos da USP - 2008
](https://www.ime.usp.br/~cef/XIImaratona/resultados/)
...
A primeira linha de cada instância contém dois inteiros $M$ e $N$ ($1 \le M \le 100000$, $1 \le N \le 1000$), que representam o número de palavras no dicionário e o número de linhas na letra da música, respectivamente.
